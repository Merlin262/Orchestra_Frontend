  ...
  return (
    <div className="overflow-y-auto max-h-[500px]">
      <div className="p-4 bg-gray-50 border-b">
        <h3 className="text-lg font-medium text-gray-900">Acompanhamento de Integrantes</h3>
      ...
      <ul className="divide-y divide-gray-200">
        {displayAssignees.map((assignee) => (
          <li key={assignee.id} className="p-4 hover:bg-gray-50">
            <div className="flex items-center">
              ...
              <div className="ml-4 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-1 text-xs rounded-full ${getStatusColor(assignee.status)}`}>
                    {getStatusText(assignee.status)}
                  </span>
                </div>
                <p className="text-sm text-gray-500 mt-1">
                  Etapa: <span className="font-medium">{assignee.taskName}</span>
                </p>
              </div>
            </div>
          </li>
