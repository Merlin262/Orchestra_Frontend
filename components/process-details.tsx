    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
      ...
      <div className="p-5 space-y-4">
        <div>
          ...
          <p className="text-gray-900">{processo.name}</p>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-gray-900">{processo.CreatedBy}</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-gray-900">{formatarData(processo.createdAt)}</p>
          </div>
        </div>
      ...
      <div className="p-5 border-t border-gray-200 bg-gray-50">
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-500">ID do Processo</span>
          <span className="text-sm font-mono bg-gray-100 px-2 py-1 rounded">{processo.id}</span>
        </div>
      </div>
    </div>
  )
